...
syn keyword   rustKeyword     match as break
syn keyword   rustKeyword     check claim cont const copy do drop else export extern fail
syn keyword   rustKeyword     for if impl use in let log
syn keyword   rustKeyword     loop mod move mut new of pure pub priv
syn keyword   rustKeyword     return self to unchecked
syn match     rustKeyword     "unsafe" " Allows also matching unsafe::foo()
syn keyword   rustKeyword     use while with
" FIXME: Scoped impl's name is also fallen in this category
syn keyword   rustKeyword     mod iface trait struct enum type nextgroup=rustIdentifier skipwhite
...
syn match     rustHexNumber   display "\<0x[a-fA-F0-9_]\+\(i\|i8\|i16\|i32\|i64\)\>"
syn match     rustBinNumber   display "\<0b[01_]\+\>"
syn match     rustBinNumber   display "\<0b[01_]\+\(u\|u8\|u16\|u32\|u64\)\>"
syn match     rustBinNumber   display "\<0b[01_]\+\(i\|i8\|i16\|i32\|i64\)\>"
