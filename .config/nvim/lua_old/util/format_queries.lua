-- Mostly copied from nvim-treesitter format script.
-- Copied here because I couldn't get it to run (couldn't find query parser,
-- even though it's installed).
--
-- Run with `:lua require'util/format_queries'.format()`
...
M.format = function()
  format(vim.api.nvim_get_current_buf(), format_queries)
end
